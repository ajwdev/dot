# NixOS configuration for an EVPN-VXLAN spine router.
# Returns a NixOS module parameterized by per-host values.
#
# Usage:
#   imports = [
...
let
  frrConfig = ''
    ! FRR configuration for ${hostname} (core router)
