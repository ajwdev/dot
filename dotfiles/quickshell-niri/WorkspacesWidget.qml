...
RowLayout {
    ...
    Repeater {
        ...
        Rectangle {
            ...
            // Compare against the reactive scalar, not workspace.is_focused:
            // niri's incremental events mutate objects in place, which QML
            // doesn't observe (see NiriService.focusedWorkspaceId).
            property bool isActive: workspace ? workspace.id === NiriService.focusedWorkspaceId : false
